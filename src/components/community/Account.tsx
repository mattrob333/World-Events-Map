    ...
    >
      <div className={styles.grid}>
        <div className={styles.stack}>
          <SignInCard />
          <p className={styles.muted}>Your traveler profiles are saved on this device, and to your account if you turn that on in Settings: <a href="/vibe#saved-title" style={{ display: 'inline-block', minHeight: 44, lineHeight: '44px', textDecoration: 'underline' }}>Open my traveler profile →</a></p>
          {user && (
