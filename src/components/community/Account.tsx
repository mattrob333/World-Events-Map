    ...
    >
      <div className={styles.grid}>
        <div className={styles.stack}>
          <SignInCard />
          <p className={styles.muted}>Your traveler profiles live on this device, not in an account: <a href="/vibe#saved-title" style={{ display: 'inline-block', minHeight: 44, lineHeight: '44px', textDecoration: 'underline' }}>Open my traveler profile →</a></p>
          {user && (
