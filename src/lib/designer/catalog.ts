...
const MALDIVES = place('maldives', [
  ...
  { id: 'dolphin-dhoni', slots: ['afternoon', 'apres'], title: 'Sunset dolphin cruise on a dhoni', blurb: 'Spinner dolphins, golden hour, cold drinks.', media: 'video', palette: ['#ea580c', '#fed7aa'], emoji: '🐬', tags: ['kids', 'views', 'water'], link: yt('Maldives sunset dolphin cruise') },
...
const ANY: DesignerCard[] = [
  { id: 'any:car-to-airport', destination: 'any', slots: ['depart'], title: 'Car to the airport', blurb: 'Leave with time to spare. Snacks in the back seat.', media: 'poster', palette: ['#334155', '#e2e8f0'], emoji: '🚗', tags: ['kids'] },
  ...
  { id: 'any:load-car', destination: 'any', slots: ['depart'], title: 'Load up the car', blurb: 'Playlist queued, snacks within reach, go when you’re ready.', media: 'poster', palette: ['#334155', '#e2e8f0'], emoji: '🧳', tags: ['kids'] },
  { id: 'any:drive', destination: 'any', slots: ['flight'], title: 'Drive there', blurb: 'Close enough for the car: no airport lines, stop when you like. Check the route and time in Maps.', media: 'poster', palette: ['#15803d', '#dcfce7'], emoji: '🚙', tags: ['kids'] },
