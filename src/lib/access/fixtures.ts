...
export const OPPORTUNITY_FIXTURES: OpportunityCard[] = [
  ...
  },
  {
    ...
    availability: 'request',
    availabilityLabel: 'Availability by request',
    body: 'Private meet-and-carry from the FBO. Winter road timing varies; the provider confirms the vehicle, not dope.travel.',
    sample: true,
  ...
  },
  {
    ...
    windowLabel: '19 Dec 2026 – 3 Jan 2027',
    body: 'Cancellation-list inquiry for a ski-in chalet. Staffing and beds are not held by dope.travel.',
    sample: true,
