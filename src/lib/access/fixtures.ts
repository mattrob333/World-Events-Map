...
export const OPPORTUNITY_FIXTURES: OpportunityCard[] = [
  {
    ...
    body: 'A ski-in residence opposite the gondola. MERIDIAN will pass your dates to the provider. No rooms are held until they confirm.',
  ...
  },
  {
    ...
    kind: 'yacht',
    title: 'Harbor morning, race week',
    ...
    availability: 'request',
    availabilityLabel: 'Availability by request',
    body: 'A berth-adjacent morning on the water. Race-week access is controlled by the harbor and the operator. Inquiry only.',
